      ...
      <CardContent className="p-8">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <h3 className="text-sm font-bold uppercase tracking-wider text-zinc-400 border-b border-zinc-100 dark:border-zinc-800 pb-2">Assets (Use of Funds, NPR)</h3>
            ...
            <div className="border border-zinc-100 dark:border-zinc-800 rounded-2xl overflow-hidden text-sm font-semibold divide-y divide-zinc-100 dark:divide-zinc-800/60">
              ...
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                ...
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(assets.cash)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                <span className="text-zinc-500 dark:text-zinc-400">Commercial Bank Accounts</span>
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(assets.bank)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                <span className="text-zinc-500 dark:text-zinc-400">Digital QR Wallets (eSewa/Khalti)</span>
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(assets.digital)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                <span className="text-zinc-500 dark:text-zinc-400">Accounts Receivable (Debtors Dues)</span>
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(assets.receivables)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                <span className="text-zinc-500 dark:text-zinc-400">Inventory Closing Stock Value</span>
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(assets.inventory)} showCurrency={false} /></span>
              </div>
              ...
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                ...
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(assets.fixedCost)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-3 items-center text-rose-600 dark:text-rose-400">
                ...
                <span className="text-right">-<NPRAmount amount={Number(assets.accumDepreciation)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-3 items-center bg-zinc-50/30 dark:bg-zinc-900/20 font-bold border-b border-zinc-200 dark:border-zinc-700">
                ...
                <span className="text-right text-zinc-900 dark:text-zinc-50"><NPRAmount amount={Number(assets.netFixed)} showCurrency={false} /></span>
              </div>
              ...
              <div className="grid grid-cols-2 px-5 py-4 items-center bg-indigo-50/30 dark:bg-indigo-950/15 font-extrabold border-t-2 border-indigo-200 dark:border-indigo-800/40 text-indigo-700 dark:text-indigo-400 text-base">
                ...
                <span className="text-right"><NPRAmount amount={Number(assets.total)} showCurrency={false} /></span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="text-sm font-bold uppercase tracking-wider text-zinc-400 border-b border-zinc-100 dark:border-zinc-800 pb-2">Liabilities & Equity (Source of Funds, NPR)</h3>
            ...
            <div className="border border-zinc-100 dark:border-zinc-800 rounded-2xl overflow-hidden text-sm font-semibold divide-y divide-zinc-100 dark:divide-zinc-800/60">
              ...
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                ...
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(liabilities.payables)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-4 items-center bg-zinc-50/50 dark:bg-zinc-900/30 font-bold border-b border-zinc-200 dark:border-zinc-700">
                ...
                <span className="text-right text-zinc-900 dark:text-zinc-50"><NPRAmount amount={Number(liabilities.total)} showCurrency={false} /></span>
              </div>
              ...
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                ...
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(equity.capital)} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-3 items-center">
                <span className="text-zinc-500 dark:text-zinc-400 font-semibold">Retained Earnings (Dynamic P&L Accumulation)</span>
                <span className="text-right text-zinc-800 dark:text-zinc-200"><NPRAmount amount={Number(equity.retainedEarnings)} showSign={true} showCurrency={false} /></span>
              </div>
              <div className="grid grid-cols-2 px-5 py-4 items-center bg-zinc-50/50 dark:bg-zinc-900/30 font-bold border-b border-zinc-200 dark:border-zinc-700">
                <span className="text-zinc-800 dark:text-zinc-200 pl-2">Total Owner Equity (C)</span>
                <span className="text-right text-zinc-900 dark:text-zinc-50"><NPRAmount amount={Number(equity.total)} showCurrency={false} /></span>
              </div>

              <div className="grid grid-cols-2 px-5 py-4 items-center bg-indigo-50/30 dark:bg-indigo-950/15 font-extrabold border-t-2 border-indigo-200 dark:border-indigo-800/40 text-indigo-700 dark:text-indigo-400 text-base">
                <span>TOTAL LIABILITIES & EQUITY (B + C)</span>
                <span className="text-right">
                  <NPRAmount amount={Number(liabilities.total) + Number(equity.total)} showCurrency={false} />
                </span>
              </div>
            </div>
          </div>
